...
title: Picker 选择器
preview: {
  web: 'https://mand-mobile.github.io/mand-mobile-3/examples/#/picker',
  uni: 'https://pt-starimg.didistatic.com/static/starimg/img/u9qqYDLhJR1628598723406.png'
}
---
...
<MDDemoWrapper>
<!-- left wrapper -->
{{{ @/packages/components/src/picker/demo/cases/demo0.vue
{{{ @/packages/components/src/picker/demo/cases/demo2.vue
<!-- right wrapper -->
}}} @/packages/components/src/picker/demo/cases/demo1.vue
</MDDemoWrapper>
