...
<MDDemoWrapper>
<!-- left wrapper -->
{{{ @/packages/components/src/date-picker/demo/cases/demo0.vue
{{{ @/packages/components/src/date-picker/demo/cases/demo2.vue
<!-- right wrapper -->
}}} @/packages/components/src/date-picker/demo/cases/demo1.vue
}}} @/packages/components/src/date-picker/demo/cases/demo3.vue
</MDDemoWrapper>
